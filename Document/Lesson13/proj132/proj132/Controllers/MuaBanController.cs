...
namespace proj132.Controllers
{
    public class MuaBanController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ds.Add(new Sanpham("sp1", "Iphone 14 pro 512", "iphone-14-pro-tim.jpg", 1000));
            ds.Add(new Sanpham("sp2", "Vsmart Aren", "vsmart-aren.jpg", 400));
            ds.Add(new Sanpham("sp3", "Realme", "realme-c11-2021-blue-1.jpg", 350));
            Session["hanghoa"] = ds;
            return View(ds);
        }
